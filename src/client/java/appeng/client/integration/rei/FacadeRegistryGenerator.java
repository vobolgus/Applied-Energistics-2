...
class FacadeRegistryGenerator implements DynamicDisplayGenerator<DefaultShapedDisplay> {
    ...
    private DefaultShapedDisplay make(ItemStack textureItem, ItemStack result) {
        ...
        // was: new ShapedRecipe("", CraftingBookCategory.MISC, pattern, result) - 26.1 recipe ctor shape
        // (mirrors the JEI integration's FacadeRegistryPlugin)
        ...
        return new DefaultShapedDisplay(
                new RecipeHolder<>(
                        ...
                        new ShapedRecipe(commonInfo, bookInfo, pattern,
