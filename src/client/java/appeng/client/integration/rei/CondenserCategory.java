...
class CondenserCategory implements DisplayCategory<CondenserOutputDisplay> {
    ...
    public List<Widget> setupDisplay(CondenserOutputDisplay recipeDisplay, Rectangle bounds) {
        ...
        // was: a Widgets.createDrawableWidget that queued a tooltip when hovered - DrawableConsumer is
        // unimplementable against REI 21.11 on 26.1 (pre-26.1 GuiGraphics signature); REI's stock tooltip-area
        // widget does the same thing.
        widgets.add(Widgets.createTooltip(
                new Rectangle(origin.x + 78, origin.y + 28, 16, 16),
