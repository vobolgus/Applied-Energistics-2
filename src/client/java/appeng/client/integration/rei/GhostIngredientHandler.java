...
import appeng.client.integrations.itemlists.DropTargets;
import appeng.integration.modules.rei.GenericEntryStackHelper;

/**
 * REI allows ingredients to be dragged from a REI panel onto compatible slots to set filters and the like without
