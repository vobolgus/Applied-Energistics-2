...
public class DataComponentTypeTagProvider extends KeyTagProvider<DataComponentType<?>> {
    ...
    protected void addTags(HolderLookup.Provider registries) {
        ...
        // was DeferredRegister: AEComponents.DR.getEntries()
        for (var entry : AERegistries.entries(Registries.DATA_COMPONENT_TYPE)) {
            componentKeys.put((DataComponentType<?>) entry.get(),
                    ResourceKey.create(Registries.DATA_COMPONENT_TYPE, entry.getId()));
        }
