...
public class DriveModel implements FabricDynamicBlockStateModel {
    ...
    public void collectParts(BlockAndTintGetter level, BlockPos pos, BlockState state, RandomSource random,
        ...
        var cells = ((net.fabricmc.fabric.api.blockgetter.v2.FabricBlockGetter) level)
                .getBlockEntityRenderData(pos) instanceof DriveModelData driveModelData
                        ? driveModelData.cells()
                        : null;
    ...
    public record Unbaked(SpinnableVariant variant) implements CustomUnbakedBlockStateModel {
        ...
        public BlockStateModel bake(ModelBaker baker) {
            ...
            for (int i = 0; i < BAY_TRANSLATIONS.length; i++) {
                bayTransforms[i] = new appeng.fabric.client.render.ComposedModelState(modelState, BAY_TRANSLATIONS[i]);
            }
