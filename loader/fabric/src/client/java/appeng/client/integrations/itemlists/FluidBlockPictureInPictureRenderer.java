...
/**
 * Fabric twin of the NeoForge class with the same FQN; the only difference is that NeoForge's
 * {@code VertexConsumerWrapper} convenience base class is replaced by a plain delegating {@link VertexConsumer}
 * (GuideME's Fabric PiP precedent).
 */
