...
public class QnbFormedModel implements FabricDynamicBlockStateModel {
    ...
    public void collectParts(BlockAndTintGetter level, BlockPos pos, BlockState state, RandomSource random,
        ...
        var formedState = ((net.fabricmc.fabric.api.blockgetter.v2.FabricBlockGetter) level)
                .getBlockEntityRenderData(pos) instanceof QnbFormedState formed
                        ? formed
                        : null;
