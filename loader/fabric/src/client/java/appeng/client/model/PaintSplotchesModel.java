...
public class PaintSplotchesModel implements FabricDynamicBlockStateModel {
    ...
    public void collectParts(BlockAndTintGetter blockAndTintGetter, BlockPos blockPos, BlockState blockState,
        ...
        var modelData = ((net.fabricmc.fabric.api.blockgetter.v2.FabricBlockGetter) blockAndTintGetter)
                .getBlockEntityRenderData(blockPos);
    ...
    public @Nullable Object createGeometryKey(BlockAndTintGetter level, BlockPos pos, BlockState state,
            RandomSource random) {
        return ((net.fabricmc.fabric.api.blockgetter.v2.FabricBlockGetter) level).getBlockEntityRenderData(pos);
    }
    ...
    private void getQuads(QuadCollection.Builder quadListBuilder, @Nullable Object extraData) {
        PaintSplotches splotchesState = extraData instanceof PaintSplotches splotches
                ? splotches
                : null;
