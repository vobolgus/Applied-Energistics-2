...
public class SpatialStorageSkyRenderer implements AutoCloseable {
    ...
    private static SpatialStorageSkyRenderer instance;
    ...
    public static SpatialStorageSkyRenderer getInstance() {
        if (instance == null) {
            instance = new SpatialStorageSkyRenderer();
        }
        return instance;
    }

    public void render(Matrix4fc modelViewMatrix) {
