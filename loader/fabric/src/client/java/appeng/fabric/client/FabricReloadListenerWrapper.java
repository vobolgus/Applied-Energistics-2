...
/**
 * Adapts a vanilla {@link PreparableReloadListener} to Fabric's identified reload listener interface (GuideME
 * precedent).
 */
public class FabricReloadListenerWrapper implements IdentifiableResourceReloadListener {
    ...
    public FabricReloadListenerWrapper(Identifier id, PreparableReloadListener listener) {
        this.id = id;
